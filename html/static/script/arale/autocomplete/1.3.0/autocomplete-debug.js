...
define("arale/autocomplete/1.3.0/data-source-debug", [ "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "$" ], function(require, exports, module) {
...
define("arale/autocomplete/1.3.0/filter-debug", [ "$" ], function(require, exports, module) {
    var $ = require("$");
    var Filter = {
...
define("arale/autocomplete/1.3.0/input-debug", [ "$", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug" ], function(require, exports, module) {
    var $ = require("$");
    var Base = require("arale/base/1.1.1/base-debug");
