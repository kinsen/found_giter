...
define(['$'], function(require, exports, module) {
    (function(window) {
        ...
        var _swfPath = function() {
            var i, jsDir, tmpJsPath, jsPath, swfPath = "/static/script/gallery/zeroclipboard/ZeroClipboard.swf";
        ...
        _detectFlashSupport();
        var ZeroClipboard = function(elements, appendToTop) {
        ...
        var _bridge = function(appendToTop) {
            var flashBridge, len;
            var doc = appendToTop ? top.document : document;
            var container = doc.getElementById("global-zeroclipboard-html-bridge");
            if (!container) {
                ...
                var divToBeReplaced = doc.createElement("div");
            ...
            if (!flashBridge) {
                flashBridge = doc["global-zeroclipboard-flash-bridge"];
        ...
        var _reposition = function() {
            if (currentElement) {
                var pos = ZeroClipboard.getDOMObjectPosition ? ZeroClipboard.getDOMObjectPosition(currentElement, _globalConfig.zIndex) : _getDOMObjectPosition(currentElement, _globalConfig.zIndex);
                var htmlBridge = _getHtmlBridge(flashState.bridge);
                if (htmlBridge) {
