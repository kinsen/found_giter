...
define(['$', 'gallery/icheckbox/style.css'], function(require, exports) {
    var $ = require('$');
    ...
    iOSCheckbox = (function() {
        ...
        iOSCheckbox.prototype.play=function(){
            var new_left = this.elem.prop('checked') ? this.rightSide : 0;
            this.handle.animate({
                left: new_left
            }, this.duration);
    ...
    $.icheckbox = this.iOSCheckbox = iOSCheckbox;
